    ...
    methods: {
        ...
        onGenerate() {
            ...
            httpClient.post('/test-data-generator/generate', {
                ...
                generateManufacturers: this.generateManufacturers,
                manufacturersCount: this.manufacturersCount,
                manufacturersBranch: this.manufacturersBranch,
